        ...
        return (
            <div className="AboutUs">
                <div className="title1">
                    <p className="title_large">Huy Dũng Mobile một trong những nơi sửa chữa điện thoại hàng đầu Việt Nam</p>
                    <p>Dẫn đầu thị trường dịch vụ sửa chữa cho các thiết bị của Apple, Huy Dũng Mobile luôn là địa chỉ đáng tin cậy <br></br>
                    cho khách hàng tại thành phố Hồ Chí Minh và trên toàn quốc. Đặt mục tiêu sự hài lòng của khách hàng lên trên lợi nhuận,<br></br>
                        chúng tôi cam kết mang lại cho bạn sự thoải mái nhất khi sử dụng dịch vụ sửa chữa điện thoại tại Huy Dũng Mobile.</p>
                </div>
                    <br></br>
                    <hr></hr>
                    <br></br>
